...
class AddNewPrebidPartnerTests(TestCase):
    ...
    def test_setup_partner(self, mock_get_users, mock_get_placements,
                           mock_get_advertisers, mock_create_orders,
                           mock_create_line_items,
                           mock_create_creatives, mock_licas, mock_dfp_client,
                           mock_get_or_create_dfp_targeting_key,
                           mock_dfp_value_id_getter,
    ...
    def test_create_line_item_configs(self, mock_dfp_client):
        ...
        self.assertEqual(
            configs[0]['targeting']['inventoryTargeting'][
        ...
        self.assertEqual(
            configs[2]['targeting']['inventoryTargeting'][
                'targetedPlacementIds'],
            [9876543, 1234567]
        )
    ...
    def test_get_or_create_dfp_targeting_key_exists(self,
        ...
        mock_get_targeting.get_key_id_by_name.assert_called_once_with(
            'some-key')
