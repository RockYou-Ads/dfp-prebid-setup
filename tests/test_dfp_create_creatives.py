...
class DFPCreateCreativesTests(TestCase):
    ...
    def test_build_creative_name(self, mock_dfp_client):
        ...
        self.assertEqual(
            dfp.create_creatives.build_creative_name('coolbiddr', 'Order Up!',
                                                     1),
        ...
        self.assertEqual(
            dfp.create_creatives.build_creative_name('anotherpartner', 'ordrrr',
                                                     11),
            'anotherpartner: HB ordrrr, #11'
        )

    @patch('dfp.create_creatives.create_creative_config')
    def test_create_duplicate_creative_configs(self,
                                               mock_create_creative_config,
                                               mock_dfp_client):
        """
